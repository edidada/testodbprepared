...
namespace odb
{
  ...
  //
  template <>
  class access::view_traits_impl< ::person_count, id_mysql >:
  ...
  class access::view_traits_impl< ::person_count, id_common >:
    public access::view_traits_impl< ::person_count, id_mysql >
  {
  };
  ...
  // person_count
  //
  struct access::view_traits_impl< ::person_count, id_mysql >::query_columns:
